...
describe("#rock_paper_scissors") do
  ...
  it("should return 'tie' when rock is the object and rock is the argument") do
    game = RPS.new()
    expect(game.wins("rock", "rock")).to eq("tie")
  end

  it("should return 'tie' when paper is the object and paper is the argument") do
    game = RPS.new()
    expect(game.wins("paper", "paper")).to eq("tie")
  end

  it("should return 'tie' when scissors is the object and scissors is the argument") do
    game = RPS.new()
